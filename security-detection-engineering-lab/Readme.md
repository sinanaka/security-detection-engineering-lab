...
└── .github/
    └── workflows/
        └── markdown-lint.yml
Purpose
This project is designed to show a detection engineering mindset, not just tool familiarity. It focuses on turning security scenarios into actionable detections that can be used by a SOC or security engineering team.
Covered use cases
